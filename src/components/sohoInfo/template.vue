    ...
    <div class="container">
      <div class="block">
          ...
          <div>
            <div class="tags_list">
              <template v-for="(t, index) in soho.soho_tags"
                ><label>{{ t }} <i class="fas fa-times-circle"></i></label
              ></template>
            </div>
          </div>
        </div>
        ...
        <div class="list">
          <span>作品：</span>
          <div>
            <div class="add_list" v-for="(w, index) in soho.work">
        ...
        <div class="list">
          <span>相關證照／證書：</span>
          <div>
            <div class="add_list" v-for="(c, index) in soho.cert">
        ...
        <div class="list">
          <span>得獎項目：</span>
          <div>
            <div class="add_list" v-for="(a, index) in soho.award">
